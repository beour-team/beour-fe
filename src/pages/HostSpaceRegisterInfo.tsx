  ...
  return (
    <div className="min-h-screen bg-white px-4 pt-6 pb-[100px] relative">
      ...
      <div className="flex items-center justify-between mb-6">
        <button
          onClick={() => navigate(PATHS.HOST.SPACE_REGISTER)}
          className="p-1"
        >
          <svg
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-1">
          ...
          <input
            className="w-full h-[3rem] bg-[#F2F3F6] rounded-lg px-4"
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="w-10 h-10 rounded-full bg-[#F2F3F6] text-2xl font-bold"
            >
              –
            </button>
        ...
        <div className="space-y-1">
          ...
          <div className="flex gap-2">
            <input
              ...
              readOnly
              className="flex-1 h-[3rem] bg-[#F2F3F6] rounded-lg px-4"
              placeholder="주소를 입력해주세요"
            />
            <button
              onClick={() => navigate("/host/register/address")}
              className="bg-black text-white rounded-lg px-4 text-sm h-[3rem]"
            >
              주소 검색
            </button>
          </div>
        ...
        <div className="space-y-1">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="bg-[#F2F3F6] text-gray-700 rounded-lg px-4 text-sm"
            >
              추가
            </button>
          </div>
          <div className="flex flex-wrap gap-2">
            {tags.map((tag, idx) => (
              <div
                key={idx}
                className="flex items-center bg-[#E5E7EB] rounded-full px-3 py-1 text-sm"
              >
                {tag}
                <button
        ...
        {[
          ...
          ["환불 정책", refundInput, setRefundInput, refunds, setRefunds],
        ].map(([label, input, setInput, list, setList], i) => (
          <div className="space-y-1" key={i}>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 h-[3rem] bg-[#F2F3F6] rounded-lg px-4"
                placeholder={`ex) ${label} 예시 입력`}
              />
              <button
                onClick={() =>
                  input && setList([...list, input]) & setInput("")
                }
                className="bg-[#F2F3F6] text-gray-700 rounded-lg px-4 text-sm"
              >
                안내 추가
