// 아이디
export const ID_REQUIRED = "아이디를 입력해주세요.";
export const ID_CHECK_REQUIRED = "아이디 중복을 확인해주세요.";
export const ID_FORMAT = "아이디는 최소 4자 이상이어야 합니다.";

// 비밀번호
export const PASSWORD_REQUIRED = "비밀번호를 입력해주세요.";
export const PASSWORD_FORMAT = "비밀번호는 최소 8자 이상이어야 합니다.";
...
export const PHONE_FORMAT = "올바른 핸드폰 번호를 입력해주세요.";
